...
const CetExams: React.FC = () => {
    ...
    const getOnlineVideoExams = () => {
        ...
        return api.post('api_new/Webservice/getOnlineExamCet', reqObj, {
            headers: {
    ...
    const updateCETExamNotificationCount = ()=>
    {
        ...
        const reqObj = {
          ...
          return api.post('api_new/balloon_notification/update_cet_exam_count', reqObj, {
            headers: {
              "Content-Type": "application/json"
            }
          }
    ...
    return (
        <IonPage>
            ...
            {flippedVideosList === null && <IonRow class="no_result_found_cls font_size_head">
              ...
              {flippedVideosList?.onlinecetexam?.map((onlineExam: any)=>{
                return(
                    <div>
