...
const EHomeWorkView: React.FC = () => {
    ...
    const getExamResult = (userData: any) => {
        ...
        const reqObj = {
            "ehomework_student_id": onlineExamData.location.state.detail.ehomework_student_id,
            "ehomework_id": onlineExamData.location.state.detail.id
        };
        return api.post('api_new/Webservice/getEhomeworkResult', reqObj, {
            headers: {
            ...
            <IonHeader>
                <IonToolbar mode="md" className="toolbar_class">
                    <IonButtons slot="start">
                        <IonBackButton />
                        <IonTitle >{onlineExamData.location.state.detail.is_attempted === "1" ? 'E HOMEWORK RESULT' : 'E HOMEWORK'}</IonTitle>
                    </IonButtons>
                </IonToolbar>
            </IonHeader>
                ...
                {onlineExamData.location.state.detail.is_attempted === '1' && <div>
                    <div className="flipped_video_exam_details">
                        ...
                        <IonRow class="videos_f_row">
                            ...
                            <IonCol>:</IonCol>
                            <IonCol size="6">
                                <p className="no_margin font_size_body f_v_e_d">{studentExamResultData?.result?.exam?.total_marks}</p>
                            </IonCol>
                        </IonRow>
                        <IonRow class="videos_f_row">
                            <IonCol size="5">
                            ...
                            <IonCol>:</IonCol>
                            <IonCol size="6">
                                <p className="no_margin font_size_body f_v_e_d">{studentExamResultData?.result?.exam?.total_scored}</p>
                            </IonCol>
                        </IonRow>
                        <IonRow class="videos_f_row">
                            <IonCol size="5">
