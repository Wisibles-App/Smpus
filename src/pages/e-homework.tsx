...
const EHomeWork: React.FC = () => {
    ...
    const getOnlineVideoExams = () => {
        ...
        return api.post('api_new/Webservice/getEhomework', reqObj, {
            headers: {
            ...
            updateCETExamNotificationCount();
            dismissIonLoading();
        }).catch((error: any) => {
    ...
    const updateCETExamNotificationCount = ()=>
    {
        ...
        const reqObj = {
          ...
          return api.post('api_new/balloon_notification/update_ehomework_count', reqObj, {
            headers: {
              "Content-Type": "application/json"
            }
          }
            ...
            <IonHeader>
                <IonToolbar mode="md" className="toolbar_class">
                    <IonButtons slot="start">
                        <IonBackButton />
                        <IonTitle >E HOMEWORK</IonTitle>
                    </IonButtons>
                </IonToolbar>
            </IonHeader>
            <IonContent>
            {flippedVideosList === null && <IonRow class="no_result_found_cls font_size_head">
                       <p> No Cet Exams Found.</p>
                        </IonRow>}
              {flippedVideosList?.ehomework?.map((onlineExam: any)=>{
                return(
                    <div>
